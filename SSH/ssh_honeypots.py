...
# Remplacer par les informations du serveur de destination. 
addresse_serveur_envoie = "20.199.78.243"
port_envoie = 8080

# Réecriture de la classe pour le serveur SSH
class SSHServer(paramiko.ServerInterface):
    def __init__(self, client_hostname, client_ip):
        self.client_hostname = client_hostname
        self.client_ip = client_ip

    # Fonction qui récupère le mot de passe et envoie les informations au serveur bdd
...
# Fonction qui envoie les informations au serveur
...
# Fonction qui gère la connexion SSH
